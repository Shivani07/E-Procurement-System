        ...
        <div class="container" style="border:1px solid white; border-radius: 5px;">
            ...
            <div class="col-sm-12 up1" style="background-image:url('images/TitleBarbg3.jpg'); background-size: 100% 100%; background-repeat: no-repeat; " >
                <div class="row" >
                    ...
                    <div class="col-sm-5" style="font-size: 40px;padding-top: 5%;">Safety Awareness</div>
            ...
            <div class="col-sm-12 cont">
                <div class="row">
                    ...
                    <div class="col-sm-9 main1"> 
                        <h2 style="text-align: center;">SAFETY AWARENESS</h2><hr/>
                    <br/><p>We at GGL believe that HEALTH, SAFETY & ENVIRONMENT are inherent part of a business. Hence, the company is making its best efforts to provide a safe and accident free environment for its customers & society. Apart from providing an environment friendly fuel to the customers, the Company uses best international practices in laying its infrastructure. The Company makes its best efforts to educate the customers to handle the fuel.</p><br/>
                        <p>The Company makes a systematic approach to promote Health, Safety & Environment in and around. The Company follows Safety Management System as HSE Policy, work permit system, personal protection, Fire & Safety Education and training, Accident reporting, investigation, Safety Audit and emergency preparedness etc.</p><br/>
                        <p>Safety of our Customers is of prime concern to us for which we follow specific system approach.</p><br/>
                        <h3 style="margin-left: 30px;">In case of a pipeline emergency</h3><br/>
...
We have also developed emergency preparedness plans for a coordinated plan of action in case of emergency.</p><br/>
                    </div>
                </div>
            </div>
