    ...
    <body>
        ...
        <form>
            <div id="wrapper">
                ...
                <div id="contain2">
                    <center>
                        <h2 style="color: navy; font-weight: bold;">Complain Management</h2>
                        <br><br>
                        <table border="1" style="width: 700px">
                            <tr><th>S.No.</th><th>Vendor Name</th><th>Contact No.</th><th>Email Address</th><th>Complain</th><th>Complain Date</th><th>Delete Complain</th></tr>
                             <%
                                    int n=1;
                                    DatabaseManager dm=new DatabaseManager();
                                    java.sql.ResultSet r=dm.selectQuery("select * from complain");
                                ...
                                <td><%=r.getString("complaintext")%></td>
                                <td><%=r.getString("complaindt")%></td>
                                <td><a href="admincode/delcomplain.jsp?fid=<%=r.getInt("id")%>">Delete</a></td>
                                </tr>
                                <%
                                    n++;
                                    }
