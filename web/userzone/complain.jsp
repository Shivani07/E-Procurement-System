        ...
        <form action="usercode/complaincode.jsp" method="post">
            <div id="wrapper">
                ...
                <div id="contain1">
                    ...
                    <div id="contain2">
                        <h2 style="color: blue; text-align: center;">Complain Form</h2>
                        <div style="margin:0 auto; width:700px;margin-bottom:20px;padding: 25px;background-color: rgba(0,5,255,0.3);border-radius: 10px;">
                        <table align="center">
                            <tr><td>Enter your Complain:</td><td><textarea name="complaintext" required="true" style="max-height: 230px; max-width: 430px;"></textarea></td></tr>
