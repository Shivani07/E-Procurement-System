        ...
        <div class="container" style="border:1px solid white; border-radius: 5px;">
            ...
            <div class="col-sm-12 up1" style="background-image:url('images/TitleBarbg3.jpg'); background-size: 100% 100%; background-repeat: no-repeat; " >
                <div class="row" >
                    ...
                    <div class="col-sm-5" style="font-size: 40px;padding-top: 5%;">News Updates</div>
            ...
            <div class="col-sm-12 cont">
                <div class="row">
                    ...
                    <div class="col-sm-9 main1"> 
                        <h2 style="text-align: center;">NEWS</h2><hr/><br/>
                        <p>1. Now You Can Register Online For  Domestic PNG Connection.</p>
                        <p>2. Commercial CNG Sale has been commenced at Prakash Auto Faizabad Road.</p>
                        <p>3. Upcoming CNG Stations:</p>
                        <p>Lucknow:  GGL – Vrindavan Yojna-18, M/s SS Filling Stn- Kanpur Road, M/s Buddeshwar FS- Mohan Road, M/s Kalawati FS-Sultanpur Road.</p>
                        <p>Agra:  Brij Auto NH-2 Sikandra, Kant Auto Tundla, Sudhir Filling Station-Runukta, Jhalak Kishori Shamshabad Road, Kalindi Vihar.</p>
                     </div>
                </div>
            </div>
