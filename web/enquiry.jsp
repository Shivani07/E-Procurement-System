        ...
        <div class="container" style="border:1px solid white; border-radius: 5px;">
            ...
            <div class="col-sm-12 up1" style="background-image:url('images/TitleBarbg3.jpg'); background-size: 100% 100%; background-repeat: no-repeat; " >
                <div class="row" >
                    ...
                    <div class="col-sm-5" style="font-size: 40px;padding-top: 5%;">Enquiry</div>
            ...
            <div class="col-sm-12 cont">
                <div class="row">
                    ...
                    <div class="col-sm-9 main1"><section id="contact" style="height: 670px; width:100%;"> <br/>
                    <h1 style="text-align: center; color: lightsteelblue;"><u>Enquiry Form</u></h1><br/><br/>
                    <table align="center">
                        <tr class="spaceUnder"><td>Enter your name</td><td><input class="form-control" type="text" name="name"/></td></tr>
                        <tr class="spaceUnder"><td>Select your gender</td><td><input type="radio" name="gender" value="Male"/>Male<input type="radio" name="gender" value="Female"/>Female</td></tr>
                        <tr class="spaceUnder"><td>Enter your address</td><td><textarea class="form-control" name="address"></textarea></td></tr>
                        <tr class="spaceUnder"><td>Enter your Contact No.</td><td><input class="form-control" type="text" name="contactno"/></td></tr>
                        <tr class="spaceUnder"><td>Enter your email address</td><td><input class="form-control" type="text" name="emailaddress"/></td></tr>
                        <tr class="spaceUnder"><td>Enter text message</td><td><textarea class="form-control" name="message"></textarea></td></tr>
                        <tr class="spaceUnder"><td></td><td><input class="submit" type="submit" value="Submit"/></td>
                    </table>
                        </section>
                </div>
            </div>
