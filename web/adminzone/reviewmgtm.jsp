                ...
                <div id="contain2">
                    <center>
                        ...
                        <table border="1" style="width: 700px">
                            <tr><th>S.No.</th><th>Posted By</th><th>Rating</th><th>Review</th><th>Review Date</th><th>Delete Review</th></tr>
                             <%
                                    int n=1;
                                    DatabaseManager dm=new DatabaseManager();
                                    java.sql.ResultSet r=dm.selectQuery("select * from review");
                                ...
                                <td><a href="admincode/delreview.jsp?fid=<%=r.getInt("id")%>">Delete</a></td>
                                </tr>
                                <%
                                    n++;
                                    }
